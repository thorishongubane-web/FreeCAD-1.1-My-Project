...
get_target_property(_qt_imported_implib Qt6::Qml IMPORTED_IMPLIB_RELEASE)
get_target_property(_qt_imported_link_dependencies Qt6::Qml IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE)
...
if(_qt_imported_implib)
    set_property(TARGET Qt6::Qml PROPERTY IMPORTED_IMPLIB_RELWITHDEBINFO "${_qt_imported_implib}")
endif()
if(_qt_imported_link_dependencies)
    set_property(TARGET Qt6::Qml PROPERTY IMPORTED_LINK_DEPENDENT_LIBRARIES_RELWITHDEBINFO "${_qt_imported_link_dependencies}")
endif()
