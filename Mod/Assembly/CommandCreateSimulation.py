...
class TaskAssemblyCreateSimulation(QtCore.QObject):
    def __init__(self, simFeaturePy=None):
        ...
        self.exportCsvButton = QtWidgets.QPushButton("📊 Export Calculations to CSV")
        self.exportCsvButton.clicked.connect(self.export_simulation_calculations_to_csv)
        ...
        self.assistantLayout.addWidget(self.exportCsvButton)
