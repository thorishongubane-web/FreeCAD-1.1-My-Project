...
list(APPEND _cmake_import_check_files_for_OpenEXR::Iex "${_IMPORT_PREFIX}/lib/Iex.lib" "${_IMPORT_PREFIX}/bin/Iex.dll" )
...
list(APPEND _cmake_import_check_files_for_OpenEXR::IlmThread "${_IMPORT_PREFIX}/lib/IlmThread.lib" "${_IMPORT_PREFIX}/bin/IlmThread.dll" )
...
set_target_properties(OpenEXR::OpenEXRCore PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/OpenEXRCore.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "libdeflate::libdeflate_shared"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/OpenEXRCore.dll"
  )

list(APPEND _cmake_import_check_targets OpenEXR::OpenEXRCore )
list(APPEND _cmake_import_check_files_for_OpenEXR::OpenEXRCore "${_IMPORT_PREFIX}/lib/OpenEXRCore.lib" "${_IMPORT_PREFIX}/bin/OpenEXRCore.dll" )
...
set_target_properties(OpenEXR::OpenEXR PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/OpenEXR.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/OpenEXR.dll"
  )

list(APPEND _cmake_import_check_targets OpenEXR::OpenEXR )
list(APPEND _cmake_import_check_files_for_OpenEXR::OpenEXR "${_IMPORT_PREFIX}/lib/OpenEXR.lib" "${_IMPORT_PREFIX}/bin/OpenEXR.dll" )
...
set_target_properties(OpenEXR::OpenEXRUtil PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/OpenEXRUtil.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/OpenEXRUtil.dll"
  )

list(APPEND _cmake_import_check_targets OpenEXR::OpenEXRUtil )
list(APPEND _cmake_import_check_files_for_OpenEXR::OpenEXRUtil "${_IMPORT_PREFIX}/lib/OpenEXRUtil.lib" "${_IMPORT_PREFIX}/bin/OpenEXRUtil.dll" )
